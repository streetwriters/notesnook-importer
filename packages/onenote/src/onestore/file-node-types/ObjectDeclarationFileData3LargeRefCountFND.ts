...
/**
 * The data for a {@link FileNode} structure (section 2.4.3) that specifies an object that references data for a file data object. If this object is revised, all declarations of this object MUST specify identical data. The value of the FileNode.FileNodeID field MUST be 0x073. This structure has the following format.
 */
export type ObjectDeclarationFileData3LargeRefCountFND = {
  /**
...
export function ObjectDeclarationFileData3LargeRefCountFND(
