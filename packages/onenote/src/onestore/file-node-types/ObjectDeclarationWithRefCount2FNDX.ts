...
/**
 * The data for a {@link FileNode} structure (section 2.4.3) that specifies an object with a reference count. The value of the FileNode.FileNodeID field MUST be 0x02E.
 */
export type ObjectDeclarationWithRefCount2FNDX = {
  /**
...
export function ObjectDeclarationWithRefCount2FNDX(
