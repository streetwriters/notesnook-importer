...
import { ObjectSpaceObjectPropSet } from "./shared/ObjectSpaceObjectPropSet";

/**
 * The data for a {@link FileNode} structure (section 2.4.3) that specifies an object (section 2.1.5) with a reference count. The value of the {@link FileNode.FileNodeID} field MUST be 0x0A4.
 */
export type ObjectDeclaration2RefCountFND = {
  /**
   * A {@link FileChunkReference|FileNodeChunkReference} structure (section 2.2.4.2) that specifies a reference to an {@linkcode ObjectSpaceObjectPropSet} structure (section 2.6.1).
   */
...
export function ObjectDeclaration2RefCountFND(
