...
/**
 * The data for a {@link FileNode} structure (section 2.4.3) that specifies an object with a reference count. If this object is revised, all declarations of this object MUST specify identical data. The value of the FileNode.FileNodeID field MUST be 0x0C4.
 */
export type ReadOnlyObjectDeclaration2RefCountFND = {
  /**
   * An {@link ObjectDeclaration2RefCountFND} structure (section 2.5.25) that specifies the identity and other attributes of this object (section 2.1.5). The values of the base.body.jcid.IsPropertySet and base.body.jcid.IsReadOnly fields MUST be true.
   */
...
export function ReadOnlyObjectDeclaration2RefCountFND(
  reader: OneNoteReader,
  header: FileNode
): ReadOnlyObjectDeclaration2RefCountFND {
  return {
    base: ObjectDeclaration2RefCountFND(reader, header),
