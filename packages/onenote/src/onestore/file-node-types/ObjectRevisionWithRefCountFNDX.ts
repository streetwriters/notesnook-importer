...
/**
 * The data for a {@link FileNode} structure (section 2.4.3) that specifies an object (section 2.1.5) that has been revised. The value of the FileNode.FileNodeID field MUST be 0x041. The revised object is identified by the oid field, and the revised data is at the location specified by the ref field.
 */
export type ObjectRevisionWithRefCountFNDX = {
  /**
...
export function ObjectRevisionWithRefCountFNDX(
